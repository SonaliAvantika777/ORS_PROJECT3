...
.hm {
	background-image: url('<%=ORSView.APP_CONTEXT%>/imgs/Tech.jpg');
	background-size: 100%;
	padding-top: 70px;
				...
				<div class="col-md-4 mb-4">
					...
					<br>
						...
						<div class="card-body">
							...
							<h3 class="text-center text-primary"><b>Update User</b></h3>
							<%
								} else {
									
							%>
						   
							<h3 class="text-center text-primary"><b>Add User</b></h3>

		 ...
		 aria-controls="navbarNav"	aria-expanded="false" aria-label="Toggle navigation">
		   ...
		   <div class="collapse navbar-collapse" id="navbarNav">
				...
				<li class="nav-item dropdown">
					...
					aria-expanded="false"><i class="fa fa-file"> <font style="color: white;">Marksheet</font>
				</a>
				...
				<li class="nav-item dropdown" style="padding-left: 5px"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.COURSE_CTL%>"><i
							class="fas fa-book-open"></i>Add Course</a>
							 <a class="dropdown-item" href="<%=ORSView.COURSE_LIST_CTL%>"><i
				...
				%>
				<li class="nav-item dropdown"
					style="padding-left: 3px; padding-right: 40px">
					<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="<%=ORSView.LOGIN_CTL%>?operation=<%=LoginCtl.OP_LOG_OUT%>">
							...
							<i class="fas fa-user-tie"></i>MyProfile</a>
						    ...
						    <i class="fas fa-clone"></i>JavaDoc </a>
						<%
							} else {
						%>
						<a class="dropdown-item" href="<%=ORSView.LOGIN_CTL%>"><i class="fas fa-sign-in-alt"><b> Login</b></i> 
